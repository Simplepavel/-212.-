...
void Window::connect()
{
    ...
    QObject::connect(login_RegBttn, &QPushButton::clicked, this, &Window::registration);
    QObject::connect(reg_BackBttn, &QPushButton::clicked, this,  &Window::login);
    QObject::connect(main_PlayBttn, &QPushButton::clicked, this,  &Window::play);
}
