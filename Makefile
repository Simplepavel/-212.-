...
object_file = currentuser.o database.o durakclient.o interface.o protocol.o figure.o board.o cellbutton.o utils.o roundedavatar.o profilebutton.o base64.o
